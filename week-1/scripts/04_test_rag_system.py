...
def create_complete_rag_pipeline(collection_name: str = None):
    ...
    template = [
        ChatMessage.from_system("You are an expert assistant for Probability for Data Science. Use the provided context to answer questions about Probability for Data Science concepts and applications. Provide accurate, practical answers based on the context."),
...
def main():
    ...
    try:
        ...
        # Test with a query
        test_query = args.query or "How do I implement a probability model?"
