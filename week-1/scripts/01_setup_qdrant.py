...
Usage:
    ...
    python setup_qdrant_store.py --collection probability_large_test
"""
...
def create_qdrant_document_store(collection_name: str = None, recreate_index: bool = True) -> QdrantDocumentStore:
    """
    Create and configure QdrantDocumentStore for Probability for Data Science documentation.
...
def test_connection(document_store: QdrantDocumentStore) -> bool:
    ...
    try:
        ...
        if count == 0:
            ...
            test_doc = Document(
                content="This is a test document for Probability for Data Science RAG system.",
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Setup Qdrant Document Store for Probability for Data Science RAG")
    ...
    print("🚀 Phase 1: Setting up Qdrant Document Store for Probability for Data Science RAG")
    if collection_name:
