...
def create_fastembed_indexing_pipeline(collection_name: str = None):
    ...
    # 1. File Type Router - routes .md and text files (.txt, .py treated as text/plain)
    ...
    # Join documents from both converters
    ...
    print("🚀 Ready to process Probability for Data Science documentation without rate limits!")
...
def main():
    ...
    try:
        ...
        print("\n🔄 Pipeline Flow:")
        print("   1. FileTypeRouter → Route .md, .txt, and .py files")
        ...
        expected_components = [
            "file_type_router", "text_file_converter", "markdown_converter", 
