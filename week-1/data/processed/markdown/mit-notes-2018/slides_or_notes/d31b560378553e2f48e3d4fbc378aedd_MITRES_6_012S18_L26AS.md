# D31B560378553E2F48E3D4Fbc378Aedd Mitres 6 012S18 L26As
...
• calculating absor ption probabilities
•
...
'" ..e 5 " " "
= ',,1
P (Xl = 1 ilnd XIOO = 1 1 X o 1) = ",:,.5 ~ct.(,
IrCx,=.,/'ICo,.l).'p(X,oo='/ )(,:~~) t. ~..., 10 5 cl."> J
....0
f" r
Cq'l) 'R:i f"
~ 1Tj OS~~ t)
...
= =
2 1 .N )
P (XIOO = 1 and XIOI Xo 1) =
:£> PI'
'1.0.')'" -Wc.o/
jP(X.o--I/ W(X.o. ~2...J XOOO= ~ ~I
f't. F ...
W1f,"'l'l...
f,,(14)O) ~ 2....,.00$ <
)I (c:. \
...
• need to decide on how many lines,
B~
t
, ,
•
...
if you have i active calls. then P{a departure) ::::::: iJ.L§
4
...
• absorbing state: recurrent state k with Pkk = 1
b..:
...
• ,w h at is the probability
ai
that she enrds.. ,u. p with having
n
'&lIars?
$.v ••
• = n, Ui =
...
f ;:
J O·s
• in case of unfavorable odds? 1._1
r::
,-t =­
~...:
r""
