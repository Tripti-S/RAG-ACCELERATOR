# 3Dfff8Bde1134Cec4E57Bf85Bb4D3381 Mitres 6 012S18 L21
...
= =
=
P(X O) P(failure at the ith trial) 1 - p
i
• Key assumptions:
- Independence
Jacob Bernoulli
...
- . . .
Stochastic processes
• First view: sequence of random variables X , X , ...
1 2
Interested in: E[Xi] Px -(x)
i
...
a Bernoulli process
(as o g as is de r i ed "ca sa 'Y" )
independent of N, X1, ... , XN
...
=
=
kth inter-arrival time (k 2) the Ti are i.i.d., Geometrrc(p)
• Tk Yk - Yk-1 ~
• The process starts fresh after time T
1
...
n! k(l )n-k =
• Number of arriva s S ·n n slots. Ps(k) k 0, ... , n
- (n - k) ! k! . P - P '
or fixe k - O, 1, ... ,
>._k
- e->..,
