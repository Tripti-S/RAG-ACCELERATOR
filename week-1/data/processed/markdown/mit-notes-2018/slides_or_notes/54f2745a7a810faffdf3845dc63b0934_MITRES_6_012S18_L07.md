# 54F2745A7A810Faffdf3845Dc63B0934 Mitres 6 012S18 L07
...
= I =
I (x I y) - P(X - x y)
Px1A(x I A)= P(X x I A) P
>
I
Pxw(x y defined for y such that py(y) O LPx1 (x I y) - 1
X
y
< l
4 1/20 2/20 2/20
...
2 1/20 3/20 1/20
=
Px,y(x, y) py(y) Px1y(x y)
I
1 1/20
- Px,y(x, y) - Px(x) Pv1x(Y x)
X
1 2 3 4
2
...
=
n n I n
P(A B C) P(A) P(B A) P( C I A B)
=
I I
PX,Y,z(x,y,z) Px(x)py1x(Y x)pz1x,y(z x,y)
3
...
=
I
E[g(X)] Lg(x)px(x) E[g(X) A]= Lg(x)pXIA(x)
X X
= =
I I
E[g(X) Y y] Lg(x)PxjY(x y)
X
4
...
=
n I =
• of two events. P(A B) P(A) · P(B) P(A B) P(A)
• of a· r.v. a d an event. P( - x a A) - P( - x) P(A), a
0 X
• of two r. v. 's:
(X-x a - y) - ( - X) (Y - y) ' o a
x,y
...
6
Example: ind p ndenc and conditiona independenc
.
y j L
4 1/20 2120 2/20
• Independent?
...
= + =
• Always true: var(aX) a2va (X) var(X a) var(X)
