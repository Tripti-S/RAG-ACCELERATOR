# 4Da14680987C076Bd5Aa2860Da2D1Afb Mitres 6 012S18 L01As
...
-..n..
+
If A n B = ,0 . then peA u B) = peA) PCB)
/fl./ e:
sJ (
e...pJr
6
...
+ + K
u u n n n
• p eA B C ) = p eA) P (A C B) p eN B C C ) •
l ( Aue,uc ) =
11
...
Mathematical subtleties
Countable Additivity Axiom:
If AI, A2, A3,'" is an infinite sequence of disj oi nt eve nts,
+ + + ...
...
"Thm:" "Frequency" of event A "is" peA)
- Axioms theorems
=?
...
Predictions
Proba bi lity theory
Real world
(Analysis)
Decisions
Data Models
I
In feren ce 5 tati sti cs
20
MIT OpenCourseWare
https://ocw.mit.edu
