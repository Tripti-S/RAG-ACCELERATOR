...
how confident we are in our analysis,” a senior CIA oﬀicer who’s served for
...
random. First roll: 𝑅 = 3. Second roll: 𝑅 .
1 2
• Prior probabilities (of hypotheses): 𝑃 (4-sided).
• Posterior probabilities (of hypotheses): 𝑃 (12-sided|𝑅 = 3).
1
• Prior predictive probability (of outcome): 𝑃(𝑅 = 3).
1
• Posterior predictive probability (of outcome):
𝑃 (𝑅 = 8|𝑅 = 3).
2 1
6/21
Concept question: Three coins
...
8/21
Concept Question: Does order matter?
...
14/21
Board Question: screening test odds
...
Collect data: 𝐷 , 𝐷 , …
1 2
Posterior odds to 𝐷 become prior odds to 𝐷 . So,
1 2
𝑃(𝐷 |𝐻) 𝑃(𝐷 |𝐻)
𝑂(𝐻|𝐷 ,𝐷 ) = 𝑂(𝐻) ⋅ 1 ⋅ 2
1 2 𝑃(𝐷 |𝐻𝑐) 𝑃(𝐷 |𝐻𝑐)
...
𝐷 and 𝐷 are conditionally independent.
1 2
𝑃(𝐷 ,𝐷 |𝐻) = 𝑃(𝐷 |𝐻)𝑃(𝐷 |𝐻).
1 2 1 2
18/21
