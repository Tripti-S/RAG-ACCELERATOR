...
are equally likely to fall on any day of the year. Consider a group of 𝑛 people, of which
you are not a member. An element of the sample space 𝑆 will be a sequence of 𝑛 birthdays
(one for each person).
...
(e) Use R simulation to estimate the smallest 𝑛 for which 𝑃 (𝐵) > 0.9. For these simula-
tions, let the number of trials be 10000. (You can reuse your code from Studio 1.)
1
18.05 Problem Set 1, Spring 2022 2
